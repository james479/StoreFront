...
namespace StoreFront.UI.MVC.Controllers
{
    public class ManufacturesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ManufactureID,ManufactureName,City,StateID,Country")] Manufacture manufacture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ManufactureID,ManufactureName,City,StateID,Country")] Manufacture manufacture)
        {
            if (ModelState.IsValid)
            {
